  ...
  <div>
    ...
    <el-card>
      <div v-show="isShowTable">
        <el-button type="primary" icon="el-icon-plus" :disabled="!category3Id" @click="addAttr" style="margin-bottom:10px;">添加属性</el-button>
        <!-- 表格：展示平台属性 -->
      ...
      <div v-show="!isShowTable">
        <el-form ref="form" label-width="80px" :model="attrInfo">
          <el-form-item label="属性名">
            <el-input placeholder="请输入属性名" v-model="attrInfo.attrName" style="width: 200px"></el-input>
          </el-form-item>
